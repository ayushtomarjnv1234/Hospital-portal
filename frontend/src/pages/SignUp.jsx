  ...
  return (
    ...
    >
      <form className="space-y-4">
        <Input label="Full Name" name="fullName" placeholder="Jane Doe" required />
        <Input label="Email" name="email" type="email" placeholder="you@example.com" required />
        <Input label="Password" name="password" type="password" placeholder="••••••••" required />
        <Input label="Phone Number" name="phone" placeholder="(123) 456-7890" />
        <Input label="Address" name="address" placeholder="123 Wellness Ave, Suite 200" />
